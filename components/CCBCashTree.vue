<template>
	...
	<view style="width: 1px; padding-bottom: 0px; margin-left: 12px; background-color: #C7C7C7;position: absolute;">
		...
		<view class="fatherV" style="margin-left: -4px; z-index: 99;">
			...
			<image class="imgIcon" style="width: 0px;" mode="aspectFit" src=""> </image>
		...
		<view v-if="true" v-for="(item, index) in treeData" :key="bindKey(index)">

			<CCBCashSubTree :subTreeData="item"> </CCBCashSubTree>
			...
			<view v-if="item.isOpen" style="margin-top: 10px; margin-left: 10px;">
				...
				<!--  otherIndex 修复小程序bug -->
				<view style="margin-left: 0px;" v-for="(subitem, otherIndex) in item.invests">
